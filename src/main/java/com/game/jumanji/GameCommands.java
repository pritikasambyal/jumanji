...
public class GameCommands {
	...
	public String roll() {
		if (userReg) {
			...
			int rolledValue = randomGenerator();
	...
	private static HashMap<Integer, List<Question>> setUpQuestionare() {
		...
		Question question1 = new Question("WHICH CITY IS HOME TO NORTH AMERICA’S LARGEST MALL?",
				Arrays.asList("1. Edmonton, Alberta", "2. Toronto, Ontario", "3. Montreal, Quebec"),
				"1.Edmonton, Alberta");
		Question question2 = new Question("WHICH CANADIAN CHAIN FIRST OPENED IN HAMILTON IN 1964?",
				Arrays.asList("1. Tim Hortons", "2. Wendy", "3. Starbucks"), "1. Tim Hortons");
		Question question3 = new Question("WHICH CITY HOSTS NORTH AMERICA’S LARGEST SINGLE DAY PARADE?",
				Arrays.asList("1. Toronto", "2. Vacouver", "3. Quebec City, Quebec"), "1. Toronto");
		Question question4 = new Question("WHAT IS CANADA’S NATIONAL SPORT?",
				Arrays.asList("1. Baseball", "2. Basketball", "3. Hockey"), "3. Hockey");
		Question question5 = new Question("WHICH CANADIAN CITY RANKS AS THE MOST EDUCATED IN THE COUNTRY?",
				Arrays.asList("1. Ottawa", "2. Toronto", "3. Montreal"), "1. Ottawa");
		Question question6 = new Question("WHICH CITY WAS HOME TO THE FIRST NORTH AMERICAN YMCA?",
				Arrays.asList("1. Ottawa", "2. Toronto", "3. Montreal"), "3. Montreal");
